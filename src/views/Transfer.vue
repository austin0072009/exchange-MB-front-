  ...
  <div style="height: 100%;">
    <mu-container>
      ...
      <div style="padding:20px;">
        ...
        <mu-button  @click="transfer"  style="margin-top: 10px;background: linear-gradient(to right, #218adc , #55c2ff);" full-width slot="append" color="primary">{{
            $t('account.transfer')
          }}
        </mu-button>
  ...
  methods: {
    getCoins() {
      ...
      this.$http({
        ...
        if (res.data.type == "ok") {
          let [lever_balance, micro_balance, change_balance,legal_balance, lever_wallet, micro_wallet, legal_wallet, change_wallet] = [
            {},
            {},
            {},
            {},
          ...
          legal_wallet.balance.forEach(x => {
            legal_balance[x.currency_name] = x.legal_balance;
          });
          ...
          for (let i = coins.length - 1; i >= 0; i--) {
            ...
            coins[i].legal_balance = legal_balance[item.currency_name];
          }
          that.coins = coins;
