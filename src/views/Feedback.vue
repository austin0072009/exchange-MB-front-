<template>
  <mu-container class="feedback" style="height: 100%;">
    ...
    <mu-dialog class="feedback bg000" width="100%" style="height: 100%;" transition="slide-bottom" fullscreen
      ...
      <div style="padding: 20px;">
        <mu-card style="width: 100%; max-width: 375px; margin: 0 auto;">
          ...
          <mu-card-text v-html="nl2br(showInfo.content)"></mu-card-text>
		  <mu-card-text v-if="img"><img :src="img" class="myimg"></mu-card-text>
        </mu-card>
