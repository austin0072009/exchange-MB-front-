export default {
  ...
  home: {
    ...
    dsp2: "Fast charging",
    dsp20:
      "Recharge withdrawal can be completed in 3 minutes at the earliest, and 24h manual online audit can protect customers from missing the best investment opportunities",
    dsp3: "Global services",
    dsp30:
      "Global business services network coverage helps you invest in global encryption assets and trade with global users",
    dsp4: "Strictly select assets",
    dsp40:
      "Strictly select high-quality encryption projects, and filter 80% high-risk projects for you",
    dsp5: "Open secure transactions anytime, anywhere",
    dsp50:
      "It covers IOS, Android and windows platforms and supports full-service functions",
  },
  login: {
    email: "Mailbox login",
    ...
    invite:
      "Register immediately and start trading on the world's leading digital asset trading platform",
  ...
  register: {
    ...
    notice:
      "Please view the user agreement and check the option box before you can click on the send verification code",
  ...
  security: {
    ...
    idcard: "Verification",
    suggest:
      "It is recommended that you change your password regularly to protect your account.",
    notbaind: "Not binded",
  ...
  legal: {
    ...
    buyall: "buy all",
    conactceil:
      "Please complete payment in 15 minutes, or it will be cancelled automatically",
  ...
  legaltrade: {
    ...
    cancel_tips:
      "Note: after canceling three times a day, Fiat will be restricted",
    send: "Send",
  ...
  set: {
    ...
    turemsg:
      "To ensure that your trade is going on properly, please fill in your information",
    tname: "Name",
  ...
  wAddress: {
    ...
    nospace03:
      "The address label must be a combination of letters and numbers. ",
  ...
  authDetail: {
    ...
    noreceiveType:
      "You haven't added the method of collection yet, please go and add it!",
  },
  identity: {
  ...
  invite: {
    ...
    tip4_1:
      "The trade account returned to the inviting person after the conversion calculation. Comission amount",
    tip4_2: " = actual volume of trades * fee * commission percentage.",
    tip5_0:
      "The platform will be held at the closing price of the currency at 08:00 Beijing time every day",
    tip5_1: "changing",
  },
  crowd: {
  ...
  miscro: {
    ...
    reply:
      "Please write down your questions and we will reply to you as soon as possible...",
    ...
    automaticallys:
      "After clicking on the exchange, it will be automatically completed and cannot be returned.",
    match: "Match",
    ...
    purchase:
      "The quantity you enter does not conform to the rules. Your purchase quota is",
    reach: "reach",
    between: "between",
    onlyEnter: "You can only enter",
    integersBetween: "Integers between",
    notReturned:
      "Click to purchase insurance, as a detailed understanding of the insurance treaty and agree that the warehouse will automatically enter into force, can not be returned.",
    settled:
      "When the insured assets lose money and cannot place an order, the insurance claims shall be settled.",
    profitable: "When assets are profitable",
    terminated: "at that time, the insurance will be automatically terminated.",
    automatically:
      "When the insured assets lose 50%, they must apply for insurance claims, otherwise they cannot be traded. When the profits are 100%, the insurance will automatically cancel the contract. The warehouse can only pay twice a day, more than twice, t+1.",
    termination:
      "After the termination of the insurance contract, the insured assets can be converted. After the termination of the contract, the insured assets are deemed to be in breach of contract, and the warehouse is cleared automatically.",
    just: "just",
    back: "back",
    ...
    safeText1:
      "Registration, password modification, and security settings for receiving validated SMS",
    safeText2:
      "Internet accounts are at risk of being stolen. It is recommended that you change your password regularly to protect account security.",
  ...
  iepn: {
    htitle:
      "A large number of coins are on sale, invite friends to earn coins together",
    subtitle:
      "A large number of coins on sale, come and buy immediately, the number is limited~",
  ...
  zhiya: {
    ...
    请联系在线客服修改密码:
      "Please contact online customer service to change the password",
  ...
  apitip: {
    ...
    请输入正确的交易数量或价格:
      "Please enter the correct transaction quantity or price",
    ...
    "用户发布c2c交易法币出售，扣除法币余额":
      "The user released the c2c transaction to sell the legal currency, deducting the balance of the legal currency",
    "用户发布c2c交易法币出售,锁定余额增加":
      "The user released the c2c transaction to sell legal currency, and the locked balance increased",
    发布成功: "Successful",
    无此用户: "No such user",
    ...
    "您的钱包已被锁定，请联系管理员":
      "Your wallet has been locked, please contact the administrator",
    "检测有未完成交易，请完成后再来！":
      "Check for unfinished transactions, please come back after completion!",
    您的余额不足: "Your balance is insufficient",
    "您的法币冻结资金异常,请查看您是否有正在进行的挂单":
      "Your fiat frozen funds are abnormal, please check if you have pending orders",
    "出售给商家法币,余额减少":
      "Sold to merchants with fiat currency, the balance is reduced",
    "出售给商家法币,锁定余额增加":
      "Sold to merchants with fiat currency, lock-in balance increases",
    "您发布的求购信息有用户出售啦，请去 APP 查看吧～":
      "The purchase information you posted is sold by users, please go to APP to check it~",
    "您发布的出售信息有用户购买啦，请去 APP 查看吧～":
      "The sales information you posted has been purchased by users, please go to APP to check it~",
    "Operation successful，请联系商家确认订单":
      "Operation successful, please contact the merchant to confirm the order",
    ...
    无此记录: "No such record",
    "该订单已操作过，请勿重复操作":
      "This order has already been operated, please do not repeat the operation",
    "对不起，您无权操作": "Sorry, you are not authorized to operate",
    buy: "buy",
    "对不起，您无权操作": "Sorry, you are not authorized to operate",
    "Operation successful，请联系卖家确认":
      "Operation successful, please contact the seller to confirm",
    "Operation successful，订单已取消":
      "Operation successful, the order has been cancelled",
    您今天的取消次数已超出:
      "You have exceeded the number of cancellations today",
    "该订单已操作，请勿取消":
      "The order has been processed, please do not cancel",
    "对不起，这不是您的发布信息": "Sorry, this is not your post",
    该订单还未付款或已经操作过:
      "The order has not been paid or has been processed",
    ...
    "出售法币成功,扣除锁定余额":
      "Successfully sell legal currency, deduct the locked balance",
    "购买法币成功，增加法币余额":
      "Successful purchase of legal currency, increase the balance of legal currency",
    在: "in",
    ...
    确认成功: "Confirm success",
    该发布信息下有交易产生无法删除:
      "There are transactions generated under the posted information that cannot be deleted",
    "对不起，您无权撤销此记录":
      "Sorry, you do not have the right to revoke this record",
    用户钱包不存在: "User wallet does not exist",
    "对不起，您的账户冻结资金不足":
      "Sorry, your account has insufficient funds frozen",
    商家撤回发布法币出售:
      "Merchants withdraw the release of fiat currency for sale",
    商家撤回发布法币出售:
      "Merchants withdraw the release of fiat currency for sale",
    ...
    "转账数量大于剩余数量!":
      "The transfer amount is greater than the remaining amount!",
    ...
    "暂时还没有邀请排行榜，快去邀请吧":
      "There is no invitation leaderboard yet, please go and invite",
    ...
    没有此用户: "No such user",
    该地址别人已经绑定过了:
      "This address has already been bound by someone else",
    ...
    美丽链法币交易余额转入:
      "Plasma fiat currency transaction balance transfer in",
    ...
    "提交成功，我们会尽快给你回复":
      "The submission is successful, we will get back to you as soon as possible",
    非法参数: "Illegal parameter",
    该币种不支持购买保险:
      "This currency does not support the purchase of insurance",
    "错误的金额！": "Wrong amount!",
    ...
    该币种不支持购买保险:
      "This currency does not support the purchase of insurance",
    "已经购买了该币种的险种！":
      "Already purchased insurance for this currency!",
    "可用余额不足，无法购买！":
      "The available balance is insufficient to purchase!",
    ...
    受保资产不符合可申请索赔条件1:
      "The insured asset does not meet the claimable conditions1",
    受保资产不符合可申请索赔条件2:
      "The insured asset does not meet the claimable conditions2",
    未知的险种类型: "Unknown type of insurance",
    "保险赔偿用户[清除受保金额]":
      "Insurance indemnity users [clear the insured amount]",
    "保险赔偿用户[赔偿受保金额]":
      "Insurance indemnity users [compensation for insured amount]",
    "保险解约，扣除保险金额":
      "Insurance termination, deduction of insurance amount",
    ...
    "保险解约，扣除受保金额":
      "Insurance termination, deduct the insured amount",
    "保险解约，扣除保险金额":
      "Insurance termination, deduction of insurance amount",
    ...
    请选择币种: "Please select currency",
    最小交易数量不能大于总数量:
      "The minimum transaction quantity cannot be greater than the total quantity",
    请填写最大交易量: "Please fill in the maximum transaction volume",
    请填写正确的最大交易量:
      "Please fill in the correct maximum transaction volume",
    币种信息有误: "The currency information is wrong",
    "对不起，您不是该法币的商家":
      "Sorry, you are not the merchant of the fiat currency",
    ...
    您还没有设置收款信息: "You haven't set up payment information",
    "未完成单子超过3单，请完成后再操作!":
      "There are more than 3 unfinished orders, please complete the operation again!",
    "商家挂单状态异常,暂时不能交易":
      "The merchant's pending order status is abnormal and cannot be traded temporarily",
    商家挂单剩余可交易数量不足:
      "The remaining transaction quantity of the merchant's pending order is insufficient",
    此条交易已完成: "This transaction has been completed",
    "非法提交，数量必须大于0":
      "Illegal submission, the quantity must be greater than 0",
    ...
    "您的法币冻结资金异常,请查看您是否有正在进行的挂单":
      "Your fiat frozen funds are abnormal, please check if you have pending orders",
    "您出售数量大于商家剩余数量!":
      "The quantity you sell is greater than the remaining quantity of the merchant!",
    "出售给商家法币:扣除余额":
      "Fiat currency sold to merchants: deduct the balance",
    "出售给商家法币:增加冻结":
      "Fiat currency sold to merchants: increased freeze",
    "您购买数量大于商家剩余数量!":
      "Your purchase quantity is greater than the remaining quantity of the merchant!",
    ",错误位于第": "The error is in the",
    "Operation successful，请联系商家确认订单":
      "Operation successful, please contact the merchant to confirm the order",
    行: "Row",
    ...
    该订单还未付款或已经操作过:
      "The order has not been paid or has been processed",
    "对不起，您的商家冻结余额不足,当前余额:":
      "Sorry, your merchant’s frozen balance is insufficient. Current balance:",
    您不能确认该订单: "You cannot confirm the order",
    订单异常: "Order exception",
    该用户没有此币种钱包: "The user does not have this currency wallet",
    ...
    "对不起，您不是该法币的商家":
      "Sorry, you are not the merchant of the fiat currency",
    "发布下架成功,将不会再与新用户匹配":
      "The release is successful and will no longer be matched with new users",
    ...
    "当前发布剩余数量不足,无法撤销":
      "The remaining number of the current release is insufficient and cannot be cancelled",
    "该发布信息下有交易正在进行中,请等待交易结束再撤回":
      "There is a transaction in progress under this posted information, please wait for the transaction to end before withdrawing",
    "对不起，您不是该法币的商家":
      "Sorry, you are not the merchant of the fiat currency",
    "对不起，您的商家账户冻结资金不足":
      "Sorry, your merchant account has insufficient funds frozen",
    "撤回失败:减少冻结资金失败":
      "Withdrawal failure: reduce the failure of frozen funds",
    ...
    "该发布信息下有交易未完成，不能标记为异常":
      "There are uncompleted transactions under the posted information and cannot be marked as abnormal",
    "该发布剩余数量不足,不法标记异常":
      "The remaining number of the release is insufficient, and the illegal flag is abnormal",
    当前发布状态无法标记异常:
      "Unable to flag exception in current release status",
    "对不起，您的商家账户冻结资金不足":
      "Sorry, your merchant account has insufficient funds frozen",
    "处理异常失败:减少冻结资金失败":
      "Failed to handle exceptions: reduce the failure of frozen funds",
    "处理异常失败:增加余额失败":
      "Failed to handle exception: Failed to increase balance",
    ...
    您未开通本交易对的交易功能:
      "You have not activated the trading function of this trading pair",
    ...
    "您有正在平仓中的交易,暂不能进行买卖":
      "You have a transaction that is in the process of liquidation, and cannot be traded temporarily",
    ...
    "当前没有获取到行情价格,请稍后重试":
      "The market price is not currently obtained, please try again later",
    限价交易卖出不能低于当前价:
      "Limit trading cannot be sold below the current price",
    限价交易买入价格不能高于当前价:
      "The purchase price of the limit transaction cannot be higher than the current price",
    "钱包未找到,请先添加钱包":
      "The wallet is not found, please add the wallet first",
    ...
    "买入(做多)止盈价不能低于开仓价和当前价":
      "The buy (long) take profit price cannot be lower than the opening price and the current price",
    "买入(做多)止亏价不能高于开仓价和当前价":
      "Buy (go long) stop loss price cannot be higher than the opening price and current price",
    "卖出(做空)止盈价不能高于开仓价和当前价":
      "The sell (short) take profit price cannot be higher than the opening price and the current price",
    "卖出(做空)止亏价不能低于开仓价和当前价":
      "Sell (short) stop loss price cannot be lower than the opening price and current price",
    设置成功: "Set successfully",
    设置失败: "Setup failed",
    数据未找到: "Data not found",
    无权操作: "No right to operate",
    "交易状态异常,请勿重复提交":
      "The transaction status is abnormal, please do not submit repeatedly",
    "平仓失败,请重试": "Failed to close the position, please try again",
    "交易异常，无法平仓":
      "The transaction is abnormal and the position cannot be closed",
    买入方向传参错误: "Incorrect parameter passing in the buying direction",
    "提交成功,请等待系统处理":
      "The submission is successful, please wait for the system to process",
    未找到需要平仓的交易: "No transaction that needs to be closed",
    "提交成功,请等待系统处理":
      "The submission is successful, please wait for the system to process",
    未找到需要平仓的交易: "No transaction that needs to be closed",
    "交易不存在或已撤单,请刷新后重试":
      "The transaction does not exist or the order has been cancelled, please refresh and try again",
    "撤单失败:用户钱包不存在":
      "Failed to cancel order: user wallet does not exist",
    撤单失败: "Cancellation failed",
    "撤单失败:变更状态失败":
      "Failed to cancel the order: failed to change the status",
    ...
    两次密码不一致: "The two passwords are inconsistent",
    "密码只能在6-16位之间111111":
      "Password can only be between 6-16 digits 111111",
    验证码错误: "Verification code error",
    ...
    "下单失败:超过最大持仓笔数限制":
      "Failed to place an order: Exceeded the maximum number of positions limit",
    ...
    受保资产为零: "Zero insured assets",
    受保资产小于等于可下单条件:
      "The insured assets are less than or equal to the condition that the order can be placed",
    "您已超过持仓限制，暂停下单。":
      "You have exceeded the position limit and the order is suspended.",
    未知的险种类型: "Unknown type of insurance",
    超过最大持仓数量限制: "Exceeded the maximum number of positions limit",
    交易中的订单大于最大挂单数量:
      "The order in the transaction is greater than the maximum number of pending orders",
    ...
    此用户还未通过实名认证:
      "This user has not passed the real-name authentication",
    币种不存在: "Currency does not exist",
    该币不是法币: "The currency is not a legal currency",
    商家名称已存在: "Business name already exists",
    此法币: "This fiat currency",
    此用户已是此法币商家:
      "This user is already a merchant of this fiat currency",
    "申请成为商家，扣除USDT": "Apply to become a merchant, deduct USDT",
    当前未获取到行情: "No market information is currently available",
    "系统配置错误，请联系系统管理员":
      "System configuration error, please contact the system administrator",
    账号不能为空: "Account cannot be empty",
    发送成功: "Sent successfully",
    账号不能为空: "Account cannot be empty",
    账号错误: "Account error",
    ...
    "【BEF】若非您本人操作，请及时修改密码。":
      "[CB-BFX] If it is not your own operation, please change the password in time.",
    发送成功: "Sent successfully",
    账号不能为空: "Account cannot be empty",
    账号错误: "Account error",
    账号已存在: "Account already exists",
    ...
    "非法操作,不能撤回非自己发布的信息":
      "Illegal operation, cannot withdraw information that is not posted by yourself",
    "非法操作:(": "Illegal operation",
    取销卖出交易失败: "Failed to cancel the sale transaction",
    "取消买入交易,解除币币余额锁定":
      "Cancel the buy transaction and unlock the currency balance",
    "取消买入交易,解除法币余额锁定":
      "Cancel the buy transaction and unlock the fiat currency balance",
    用户未找到: "User not found",
    取消成功: "Cancel success",
    取销卖出交易失败: "Failed to cancel the sale transaction",
    "取消卖出交易,解除交易余额锁定":
      "Cancel the sell transaction and unlock the transaction balance",
    "取消卖出交易,解除交易余额锁定":
      "Cancel the sell transaction and unlock the transaction balance",
    取消成功: "Cancel success",
    类型错误: "Type error",
    ...
    "你今天的交易额度已达到上限!":
      "Your trading limit today has reached the upper limit!",
    数据未找到: "Data not found",
    余额不足: "Insufficient balance",
    ...
    您的币不足: "You don’t have enough coins",
    "您的冻结资金异常，禁止挂卖":
      "Your frozen funds are abnormal, it is forbidden to sell",
    ...
    "资产兑换,减少持有币法币:":
      "Asset exchange, reduce holding currency and legal currency",
    "兑换数量大于持有资产!":
      "The exchange amount is greater than the holding assets!",
    "资产兑换,减少": "Asset exchange, reduction",
    "资产兑换,增加USDT杠杆币":
      "Asset exchange, increase USDT leveraged currency",
    扣除手续费: "Deduction fee",
    "法币数量:": "Number of legal currency",
    "兑换数量大于剩余数量!":
      "The exchanged quantity is greater than the remaining quantity!",
    ...
    "您有正在进行中的杆杠交易,不能进行此操作":
      "You have an ongoing leverage transaction and cannot perform this operation",
    ...
    下单数量必须是10的整数倍:
      "The order quantity must be an integral multiple of 10",
    "Parameter error": "Parameter error",
    "提币申请已成功，等待审核":
      "The withdrawal application has been successful and is waiting for review",
    两次密码不一致: "The two passwords are inconsistent",
    ...
    支付密码错误: "Incorrect payment password",
    "钱包已添加,请勿重复添加":
      "The wallet has been added, please do not add it repeatedly",
    ...
    "您有未平仓的交易,操作禁止":
      "You have open trades, operations are prohibited",
    "操作失败:您有未平仓的交易,操作禁止":
      "Operation failed: you have an open trade, the operation is prohibited",
    "购买失败，购买金额必须大于":
      "Purchase failed, purchase amount must be greater than",
    并且小于: "And less than",
    ...
    修改邮箱: "Modify email",
    您输入的邮箱或手机号不符合规则:
      "The email or phone number you entered does not meet the rules",
    ...
    "秒合约订单平仓,盈利结算":
      "Second contract order closing, profit settlement",
    ...
    位: "Bit",
    "杠杆买入委托撤单,退回手续费":
      "Cancellation of leveraged buy orders, refund of handling fee",
    "杠杆买入委托撤单,退回保证金":
      "Cancellation of leveraged buy orders and refund of margin",
    "秒合约买入委托撤单,退回手续费":
      "Second contract buy order cancellation, refund of handling fee",
    "秒合约买入委托撤单,退回保证金":
      "Second contract buy order cancellation, return margin",
    "法币买入委托撤单,退回手续费":
      "Cancellation of fiat currency buy orders, refund of handling fee",
    "法币买入委托撤单,退回保证金":
      "Cancellation of fiat purchase orders and refund of margin",
    "币币买入委托撤单,退回手续费":
      "Cancellation of token purchase orders, refund of handling fee",
    "币币买入委托撤单,退回保证金":
      "Cancellation of token purchase orders and refund of deposit",
    ...
    认购成功: "Successfully subscribed",
    下单数量必须是100的整数倍:
      "The order quantity must be an integral multiple of 100",
    认购解锁到账: "Subscription unlocked",
    充值自动到账: "Recharge automatically arrives",
    "发送失败。未包含正确的手机号":
      "Failed to send. Does not contain the correct phone number",
