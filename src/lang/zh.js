export default {
    ...
    "auth2": {
        ...
        "tip4": " 请提供一张您本人的FTX账号的资产明细截图或者照片，图片中包含您的账户名、uid、持仓详情、当前时间。所有信息清晰可读。",
        "screenshot": "上传资产截图信息",
        "nowLever": "当前认证等级",
        "authCard": "身份证",
        "hu": "护照",
    ...
    "tpc": {
        ...
        "nodata": "暂无数据",
        "search": "搜索",
        "tips": "*当前页展示内容为项目方自行填写，FTX不对此内容真实性负责",
        "time": "发行时间",
        "total": "发行总量",
        "circulation": "代币流通量",
        "price": "发行价",
...
"apitip":{
	...
	"账号已存在":"账号已存在",
	"请填写账号":"请填写账号",
	"【BEF】若非您本人操作，请及时修改密码。":"【CB-BFX】若非您本人操作，请及时修改密码。",
	"发送失败":"发送失败",
	"ip参数不正确":"ip参数不正确",
	"邮箱不能为空":"邮箱不能为空",
	"短信验证码":"短信验证码",
